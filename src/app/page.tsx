...
export const metadata: Metadata = {
  title: "StrainHub | Cannabis Strain Database — 455+ Strains, Effects & Grow Info",
  description: "The most comprehensive cannabis strain database. 455+ strains with effects, terpenes, THC/CBD levels, grow guides and more. Free forever.",
  keywords: [
