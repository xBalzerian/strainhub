    ...
    <>
      ...
      <div className="bg-[#0D0D0D] border-b-2 border-[#AAFF00]/20 py-8">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-white text-[#0D0D0D] font-black border-2 border-[#0D0D0D] shadow-[3px_3px_0px_#AAFF00] hover:shadow-[5px_5px_0px_#AAFF00] hover:-translate-y-0.5 px-6 py-3 rounded-xl transition-all text-sm"
          >
      ...
      <section id="team" className="bg-[#F4F4F0] py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Farm Gallery — Expanded Bento Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">

            {/* Row 1 — aerial hero (2 cols) + morning shot */}
            <div className="sm:col-span-2 relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-[16/9]">
              <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/13217f19b_generated_image.png" alt="Aerial view of GreenScale Agro cannabis farm — 38 hectares, Cundinamarca Colombia" className="w-full h-full object-cover" />
            ...
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-square">
              <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/654e3007d_generated_image.png" alt="Morning at cannabis greenhouse complex Colombia" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D]/80 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <span className="inline-block bg-[#AAFF00] text-[#0D0D0D] text-xs font-black px-3 py-1 rounded-full mb-2">🌅 Early Morning</span>
                <p className="text-white font-bold text-sm">Greenhouse Complex at Sunrise</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            ...
            {/* Farm entrance */}
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-square">
              <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/199aa7f5c_generated_image.png" alt="Farm entrance gate and driveway" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D]/80 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <span className="inline-block bg-[#AAFF00] text-[#0D0D0D] text-xs font-black px-3 py-1 rounded-full mb-2">🚪 Farm Entrance</span>
                <p className="text-white font-bold text-sm">Main Gate — GreenScale Agro</p>
              </div>
            </div>

            {/* Inside greenhouse close-up */}
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-square">
              <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/abd97bffe_generated_image.png" alt="Inside cannabis greenhouse close up plants" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D]/80 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                ...
                <p className="text-white font-bold text-sm">Pharmaceutical-Grade Cultivation</p>
              </div>
            </div>

            {/* Twilight Portugal */}
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-square">
              <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/2351d4bd9_generated_image.png" alt="Terra Verde Holdings Portugal at dusk" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D]/80 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            {/* Processing facility Portugal */}
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-video">
              <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/68d685321_generated_image.png" alt="Cannabis processing facility aerial Portugal" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D]/80 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <span className="inline-block bg-[#AAFF00] text-[#0D0D0D] text-xs font-black px-3 py-1 rounded-full mb-2">🏭 Processing Facility</span>
                <p className="text-white font-bold text-sm">Aerial — Terra Verde Processing & Logistics Hub</p>
              </div>
            </div>

            {/* Drying room */}
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-video">
              <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/b0af30c6a_generated_image.png" alt="Cannabis drying room harvest" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D]/80 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <span className="inline-block bg-[#AAFF00] text-[#0D0D0D] text-xs font-black px-3 py-1 rounded-full mb-2">🌾 Post-Harvest</span>
                <p className="text-white font-bold text-sm">Climate-Controlled Drying & Curing Room</p>
              </div>
            </div>

          </div>

          {/* Full panoramic inside greenhouse */}
          <div className="relative rounded-2xl overflow-hidden border-2 border-[#0D0D0D] shadow-[4px_4px_0px_#0D0D0D] aspect-[21/9] mb-8">
            <img src="https://media.base44.com/images/public/69b215547e21a09debcd5b78/cd5d8c8dd_generated_image.png" alt="Wide panoramic inside industrial cannabis greenhouse" className="w-full h-full object-cover object-center" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D]/70 via-transparent to-transparent" />
            <div className="absolute bottom-4 left-4 right-4">
              <span className="inline-block bg-[#AAFF00] text-[#0D0D0D] text-xs font-black px-3 py-1 rounded-full mb-2">🌿 Full Scale View</span>
              <p className="text-white font-bold text-sm sm:text-base">7,500+ plants per annual cycle — full climate control, pharmaceutical-grade standards</p>
            </div>
          </div>
