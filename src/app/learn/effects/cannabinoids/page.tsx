...
export const metadata: Metadata = {
  title: "Cannabinoid Pharmacology | StrainHub Learn",
  description: "Comprehensive guide to cannabinoid pharmacology — science-backed cannabis education from StrainHub.",
};
    ...
    <div className="min-h-screen bg-[#F8F8F0]">
      ...
      <div className="bg-white border-b-2 border-black">
        <div className="max-w-3xl mx-auto px-6 py-14">
          ...
          <h1 className="text-4xl font-black text-black mb-4">Cannabinoid Pharmacology</h1>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://base44.app/api/apps/69b215547e21a09debcd5b78/files/public/69b215547e21a09debcd5b78/1243d3a2a_cannabinoids.jpg" alt="Cannabinoid molecular structures illustration" className="w-full h-56 md:h-72 object-cover rounded-2xl border border-gray-100 mt-6 mb-2" />
