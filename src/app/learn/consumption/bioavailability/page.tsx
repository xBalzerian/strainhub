...
export const metadata: Metadata = {
  title: "Bioavailability Deep Dive | StrainHub Learn",
  description: "Comprehensive guide to bioavailability deep dive — science-backed cannabis education from StrainHub.",
};
    ...
    <div className="min-h-screen bg-[#F8F8F0]">
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-3xl mx-auto px-6 py-3 flex items-center gap-2 text-xs text-gray-400">
          ...
          <span className="text-black font-semibold">Bioavailability Deep Dive</span>
        </div>
      </div>
      <div className="bg-white border-b-2 border-black">
        <div className="max-w-3xl mx-auto px-6 py-14">
          ...
          <h1 className="text-4xl font-black text-black mb-4">Bioavailability Deep Dive</h1>
