...
export const metadata: Metadata = {
  title: "Method Selection Framework | StrainHub Learn",
  description: "Comprehensive guide to method selection framework — science-backed cannabis education from StrainHub.",
};
    ...
    <div className="min-h-screen bg-[#F8F8F0]">
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-3xl mx-auto px-6 py-3 flex items-center gap-2 text-xs text-gray-400">
          ...
          <span className="text-black font-semibold">Method Selection Framework</span>
        </div>
      </div>
      <div className="bg-white border-b-2 border-black">
        <div className="max-w-3xl mx-auto px-6 py-14">
          ...
          <h1 className="text-4xl font-black text-black mb-4">Method Selection Framework</h1>
