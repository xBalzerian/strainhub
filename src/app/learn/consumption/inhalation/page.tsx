...
export const metadata: Metadata = {
  title: "Inhalation Methods | StrainHub Learn",
  description: "Comprehensive guide to inhalation methods — science-backed cannabis education from StrainHub.",
};
    ...
    <div className="min-h-screen bg-[#F8F8F0]">
      ...
      <div className="bg-white border-b-2 border-black">
        <div className="max-w-3xl mx-auto px-6 py-14">
          ...
          <h1 className="text-4xl font-black text-black mb-4">Inhalation Methods</h1>
