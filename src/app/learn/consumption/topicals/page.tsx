...
export const metadata: Metadata = {
  title: "Topical & Transdermal Applications | StrainHub Learn",
  description: "Comprehensive guide to topical & transdermal applications — science-backed cannabis education from StrainHub.",
};
    ...
    <div className="min-h-screen bg-[#F8F8F0]">
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-3xl mx-auto px-6 py-3 flex items-center gap-2 text-xs text-gray-400">
          ...
          <span className="text-black font-semibold">Topical & Transdermal Applications</span>
        </div>
      </div>
      <div className="bg-white border-b-2 border-black">
        <div className="max-w-3xl mx-auto px-6 py-14">
          <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-4" style={{ background: "#f0f9ff", color: "#0369a1" }}>
            Learn Hub
          </div>
          <h1 className="text-4xl font-black text-black mb-4">Topical & Transdermal Applications</h1>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="bg-white border-2 border-dashed border-gray-200 rounded-2xl p-8 text-center">
          ...
          <Link href="/learn/consumption" className="inline-flex items-center gap-2 bg-black text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-gray-800 transition-all">
            ← Back to Consumption
          </Link>
        </div>
      </div>
