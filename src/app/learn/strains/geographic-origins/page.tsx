...
export const metadata: Metadata = {
  title: "Regional & Geographic Origins | StrainHub Learn",
  description: "Comprehensive guide to regional & geographic origins — science-backed cannabis education from StrainHub.",
};
    ...
    <div className="min-h-screen bg-[#F8F8F0]">
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-3xl mx-auto px-6 py-3 flex items-center gap-2 text-xs text-gray-400">
          ...
          <span className="text-black font-semibold">Regional & Geographic Origins</span>
        </div>
      </div>
      <div className="bg-white border-b-2 border-black">
        <div className="max-w-3xl mx-auto px-6 py-14">
          ...
          <h1 className="text-4xl font-black text-black mb-4">Regional & Geographic Origins</h1>
