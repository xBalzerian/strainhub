// src/app/sitemap.ts - Sitemap INDEX (points to sub-sitemaps for better crawl budget)
...
export default function sitemap(): MetadataRoute.Sitemap {
  // This is now a simple static sitemap index - sub-sitemaps handle the dynamic content
  // We return static pages here + point crawlers to sub-sitemaps via robots.txt
  return [
    ...
    { url: `${BASE_URL}/seedbanks`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
